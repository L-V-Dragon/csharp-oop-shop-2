...
Liquido prodotto2 = new Liquido("Acqua", "Bene Primario", false, "Acqua", 1.50, 22);
Liquido prodotto3 = new Liquido("Monster", "Bibita" , true, "Bibita energetica dolce", 2.50, 22);
...
List<Prodotto> list = new List<Prodotto>() { prodotto1, prodotto2, prodotto3, prodotto4, prodotto5 };
